...
class ContatosControllerTest < ActionController::TestCase
  ...
  test "should create contato" do
    assert_difference('Contato.count') do
      post :create, contato: { email: @contato.email, facebook: @contato.facebook, nome: @contato.nome, telefone: @contato.telefone, twitter: @contato.twitter }
    end
  ...
  test "should update contato" do
    put :update, id: @contato, contato: { email: @contato.email, facebook: @contato.facebook, nome: @contato.nome, telefone: @contato.telefone, twitter: @contato.twitter }
    assert_redirected_to contato_path(assigns(:contato))
  end
